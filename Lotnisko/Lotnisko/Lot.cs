...
namespace Projekcik
{
    ...
    public class Lot
    {
        ...
        /// <summary>
        /// zmienna określająca czy ma wrocić, koncepcja lotu polega na tym że leci do miejsca docelowego , a później wraca, tworzy to dwa połączenia , można w sumie wywalić i trzeba określać loty w dwie strony oddzielnie
        /// </summary>
        public Boolean CzyMaWracac;
        ~Lot()
        {
            this.GetSamolot().SetCzyDostepny(true);  // kiedu Lot jest usuwany samolot jest zwalniany
        }

        /// <summary> Podstawowy konstruktor do lotu </summary>
        ...
        /// </summary>
        public Lot(Lot IstniejącyLot, TimeSpan PrzesuniecieCzasowe, String ID)
        {
            LNIDRezerwacjiBiletow = new List<string>();
            ListaRezerwacji = new List<RezerwcjaBilet>();
            ...
            DataGodzinaWylotu = DataGodzinaWylotu.Add(PrzesuniecieCzasowe);
        ...
        public Lot(Lot IstniejacyLot, string _IDLotu, TimeSpan IloscCzasuDoStartuLiczonaOdMomentuLondowania)
        {
            ...
            this.SetPojazd(IstniejacyLot.GetTypSamolotu(), IstniejacyLot.GetSamolot().GetIDSamolotu());
        ...
        /// <summary> Zwraca ID lotu </summary>
        public string GetIDLotu()
        {
            return IDLotu;
        }
        /// <summary> Zwraca ID samolotu </summary>
        public string GetIDSamolotu()
        {
            return IDSamolotu;
        }
        /// <summary> Zwraca listę rezerwacji </summary>
        public List<RezerwcjaBilet> GetListaRezerwacji()
        {
             return ListaRezerwacji;
        }
        /// <summary> Zwraca typ samolotu </summary>
        public TypSamolotu GetTypSamolotu()
        {
            return Pojazd;
        }
        /// <summary> Zwraca czas lotu </summary>
        public TimeSpan GetCzasLotu()
        {
            return CzasLotu;
        }
        /// <summary> Zwraca drogę </summary>
        public Trasa GetDroga()
        {
            return Droga;
        }
        /// <summary> Zwraca datę godzinę wylotu </summary>
        public DateTime GetDataGodzinaWylotu()
        {
        ...
        public string PrzydzielanieIDRezerwacja()
        {
            ...
            else
            {
                if (ListaRezerwacji.Count() != 0)
                {
                    ...
                    return IDLotu + "-" + NumerekbezFormatu;
                }
                else
                    return IDLotu + "-" + "001";
